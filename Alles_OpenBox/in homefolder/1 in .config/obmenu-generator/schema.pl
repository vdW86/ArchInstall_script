...
our $SCHEMA = [
	...
	{item => ['firefox',  			'Internet',			'firefox']},
	{item => ['thunderbird',        'Email',			'thunderbird']},
    {item => ['pcmanfm',        	'Verkenner',		'file-manager']},
    
     
 ## Custom advanced settings
      {begin_cat => ['Advanced Settings', 'gnome-settings']},
     {begin_cat => ['Tools', 'openbox']},
			{item => ['xterm',  'Terminal','terminal']},
			{item => ['balena-etcher-electron',  'Balena Etcher','balena-etcher-electron']},
			{item => ['leafpad',  'Leafpad','leafpad']},
			{item => ['nitrogen',  'Bureaublad Achtergrond','nitrogen']},
			{item => ['pavucontrol',  'Geluidinstellingen','pavucontrol']},
			{item => ['pinta',  'Paint','pinta']},
			{item => ['gimp',  'PhotoShop','gimp']},
			{item => ['vlc',  'Mediaspeler VLC','vlc']},
 			#{item => ['gufw',  'Firewall Instellingen','gufw']},
 			{item => ['woeusbgui',  'Windows Opstart USB Maken ','woeusbgui']},
 			{item => ['gksudo pcmanfm',  'Verkenner als beheerder ','pcmanfm']},
 			{sep => undef},
            {end_cat => undef},
        # Customize
        {begin_cat => ['Customize', 'theme']},
            {item => ["$editor ~/.conkycolors/conkyrc",  'conky_rechts',  'text-x-source']},
            {item => ["$editor ~/.conkycolors/conkyrc_l",  'conky_links',  'text-x-source']},
            {sep => undef},
        ...
        {begin_cat => ['Openbox', 'openbox']},
            ...
            {item => ['openbox --restart',  'Openbox Verversen ','openbox']},
    ...
    #{item => ['xterm poweroff', 'Computer Uitschakelen', 'exit']},
    {item => ['systemctl --no-wall poweroff', 'Computer Uitschakelen', 'exit']},
    {sep => undef},
